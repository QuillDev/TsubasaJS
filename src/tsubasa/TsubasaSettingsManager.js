...
const TsubasaSettings = require("../tsubasa-abstract/TsubasaSettings");


//TODO Look at this or rewrite when I understand SQLite more
class TsubasaSettingsManager {
    constructor(client) {
        this.client = client;
        this.db = null;
        ...
        //open the settings file as a sqlite database
    ...
    async get(guildID, createIfNotExist = false) {
        ...
        return new TsubasaSettings(statement, this.db);
    }
...
module.exports = TsubasaSettingsManager;
